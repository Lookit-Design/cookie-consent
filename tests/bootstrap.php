 ...
 */
function _lookit_cookie_consent_load_plugin() {
	require dirname( __DIR__ ) . '/lookit-cookie-consent.php';
}
tests_add_filter( 'muplugins_loaded', '_lookit_cookie_consent_load_plugin' );
